...
<ScrollView xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout
        ...
        <LinearLayout
            ...
            <TextView
                android:text="🍽️ Evimin Lezzetleri"
            ...
            <TextView
                android:text="Lezzetli tariflerini kaydet"
        ...
        <LinearLayout
            ...
            <EditText
                ...
                android:hint="Tarif adı (örn: Menemen)"
        ...
        <!-- Filtre -->
        <TextView
            android:text="📂 Kategoriye Göre Tarifler"
            android:textStyle="bold"
            android:textSize="15sp"
...
card_bg.xml (Tarif Kartları İçin)
